...
describe('SparseMatrix', function() {
  ...
  describe('get subset', function() {
    ...
    /*it('should get the right subset of the matrix', function() {
      ...
      let invArg00 = index(1, 1);
      let res0 = m.subset(invArg00);
      assert.deepEqual(res0, 5);

      //TODO: uncomment
      let invArg100 = new Range(0, 2);
      let invArg101 = new Range(0, 2);
      let invArg10 = index(invArg100, invArg101);
      assert.deepEqual(m.subset(invArg10).toArray(), [[1, 2], [4, 5]]);

      let invArg201 = new Range(1, 3);
      let invArg20 = index(1, invArg201);
      assert.deepEqual(m.subset(invArg20).toArray(), [[5, 6]]);

      let invArg301 = new Range(1, 3);
      let invArg30 = index(0, invArg301);
      assert.deepEqual(m.subset(invArg30).toArray(), [[2, 3]]);

      let invArg401 = new Range(1, 3);
      let invArg40 = index(invArg401, 1);
      assert.deepEqual(m.subset(invArg40).toArray(), [[5], [8]]);

      let invArg501 = new Range(1, 3);
      let invArg50 = index(invArg501, 2);
      assert.deepEqual(m.subset(invArg50).toArray(), [[6], [9]]);

      let invArg601 = new Range(1, 3, 2);
      let invArg60 = index(invArg601, 2);
      assert.deepEqual(m.subset(invArg60).toArray(), [[6]]);

      let invArg700 = [0, 1];
      let invArg701 = [2, 1];
      let invArg70 = index(invArg700, invArg701);
      assert.deepEqual(m.subset(invArg70).toArray(), [[3, 2], [6, 5]]);

      let invArg800 = [0, 1, 2];
      let invArg801 = [2, 1, 0];
      let invArg80 = index(invArg800, invArg801);
      assert.deepEqual(m.subset(invArg80).toArray(), [[3, 2, 1], [6, 5, 4], [9, 8, 7]]);
      
      let invArg900 = [2, 1, 0];
      let invArg901 = [0, 1, 2];
      let invArg90 = index(invArg900, invArg901);
      assert.deepEqual(m.subset(invArg90).toArray(), [[7, 8, 9], [4, 5, 6], [1, 2, 3]]);
      
      let invArg10000 = [2, 1, 0];
      let invArg10001 = [2, 1, 0];
      let invArg1000 = index(invArg10000, invArg10001);
      assert.deepEqual(m.subset(invArg1000).toArray(), [[9, 8, 7], [6, 5, 4], [3, 2, 1]]);
  ...
  describe('set subset', function() {
    ...
    //analyzed alone, produces valid tests
    /*it('should set scalar value', function () {
      ...
      let invArg1_10 = index(0, 0);
      m.subset(invArg1_10, 2);
      assert.deepEqual(
        m.toArray(), 
        [
          [2, 0],
    ...
    /*it('should set scalar value growing matrix', function () {
      ...
      let invArg2_00 = index(2, 2);
      m.subset(invArg2_00, 2);
      assert.deepEqual(
        m.toArray(), 
        [
          [0, 0, 0],
    ...
    /*it('should set scalar value growing matrix, default value', function () {
      ...
      let invArg3_00 = index(2, 2);
      m.subset(invArg3_00, 2, 1);
      assert.deepEqual(
        m.toArray(), 
        [
          [0, 0, 1],
    ...
    /*it('should set vector value', function () {
      ...
      let invArg4_000 = [0, 2];
      let invArg4_00 = index(0, invArg4_000);
      let invArg4_01 = [1, 2];
      ...
      let invArg5_1000 = [0, 2];
      let invArg5_10 = index(1, invArg5_1000);
      let invArg5_11 = [3, 4];
      m.subset(invArg5_10, invArg5_11);
      assert.deepEqual(
        m.toArray(), 
        [
          [1, 2],
    ...
    //analyzed alone, produces invalid tests (1/3)
    /*it('should set subset', function() {
      ...
      let invArg6_000 = new Range(1, 3);
      let invArg6_001 = new Range(1, 3);
      let invArg6_00 = index(invArg6_000, invArg6_001);
      let invArg6_01 = [[1, 2], [3, 4]];
      ...
      let invArg7_100 = new Range(0, 3);
      let invArg7_10 = index(0, invArg7_100);
      let invArg7_11 = [5, 6, 7];
      ...
      let invArg8_200 = new Range(0, 3);
      let invArg8_20 = index(invArg8_200, 0);
      let invArg8_21 = [8, 9, 10];
      m.subset(invArg8_20, invArg8_21);
      assert.deepEqual(
        m.toArray(), 
        [
          [8, 6, 7],
    ...
    /*it('should set subset growing matrix', function() {
      ...
      let invArg9_000 = new Range(2, 4);
      let invArg9_001 = new Range(2, 4);
      let invArg9_00 = index(invArg9_000, invArg9_001);
      let invArg9_01 = [[1, 2], [3, 4]];
      ...
      let invArg10_100 = new Range(0, 3);
      let invArg10_10 = index(4, invArg10_100);
      let invArg10_11 = [5, 6, 7];
      ...
      let invArg11_200 = new Range(0, 3);
      let invArg11_20 = index(invArg11_200, 4);
      let invArg11_21 = [8, 9, 10];
      m.subset(invArg11_20, invArg11_21);
      assert.deepEqual(
        m.toArray(), 
        [
          [0, 0, 0, 0, 8],
    ...
    it('should set subset growing matrix, default value', function() {
      ...
      let invArg12_000 = [2, 4];
      let invArg12_001 = [2, 4];
      let invArg12_00 = index(invArg12_000, invArg12_001);
      let invArg12_01 = [[1, 2], [3, 4]];
      ...
      let invArg13_100 = new Range(0, 3);
      let invArg13_10 = index(4, invArg13_100);
      let invArg13_11 = [5, 6, 7];
      ...
      let invArg14_200 = new Range(0, 3);
      let invArg14_20 = index(invArg14_200, 4);
      let invArg14_21 = [8, 9, 10];
      m.subset(invArg14_20, invArg14_21, -3);
      assert.deepEqual(
        m.toArray(), 
        [
          [0, 0, 0, -1, 8],
    ...
    it ('should throw an error in case of wrong size of submatrix', function () {
      assert.throws(function () { 
        ...
        let m = new SparseMatrix();
        let invArg00 = index(0);
        let invArg01 = [2,3];
        m.subset(invArg00, invArg01); 
    ...
    it('should throw an error when invoked on a pattern matrix', function() {
      ...
      assert.throws(function () { 
        ...
        let invArg000 = [2, 4];
        let invArg001 = [2, 4];
        let invArg00 = index(invArg000, invArg001);
        let invArg01 = [[1, 2], [3, 4]];
        m.subset(invArg00, invArg01, -1); 
